		...
		<script type="text/javascript">
 		/*	var app = angular.module('myApp', []);  
			...
			app.controller('myCtrl', function($scope) {
			    $scope.flowValue = "Volvo";
			    $scope.changeType = function(flowValue){
		            $scope.flowValue = flowValue;
		        }
			...
			myApp.factory('incomeList',function(){
				var incomeList = {};
				incomeList.cast = [
				{
					value: "3",
			...
			myApp.factory('expenseList',function(){
				var expenseList = {};
				expenseList.cast = [
				{
					value: "1",
			...
			myApp.controller('myCtrl',function($scope,incomeList,expenseList,setNulls){			    
				$scope.types = expenseList;
				$scope.changeCashFlowType = function(cashFlowType) {
			        //console.log($scope.itemsuper);
			        //alert(cashFlowType);
			        if(cashFlowType == "Income") {
			            $scope.types = incomeList;
	                ...
	                <div class="form-group">
	                    ...
	                    <div class="input-group">
				            <label class="radio-inline">
						      <input type="radio" name="cashFlowType" id="cashFlowType" value="Income" ng-click="changeCashFlowType('Income')" ng-value="Income" ng-model="cashFlowType">Income
						    </label>
						    <label class="radio-inline">
						      <input type="radio" name="cashFlowType" id="cashFlowType" value="Expense" ng-click="changeCashFlowType('Expense')" ng-value="Expense" ng-model="cashFlowType">Expense
						    </label>
	                    </div>
	                </div>
	                <div class="form-group">
	                    ...
	                    <select name="inExpType" id="inExpType" class="form-control" data-role="listview" ng-options="type as type.text for type in types.cast " ng-model="inExpType">
<!-- 					        <option>Select</option>
					        <option>LIC Return</option>
...
function addCashFlowRow(){
	...
	if(cashFlowType!=null && cashFlowType !='undefind'){
	    ...
	    if(!validateValues){
	    	...
	    	cell1.innerHTML = "<div style='display:none' id='"+ tableType +"_type_"+ rowCount +"'>"+ type_val +" </div> <div>"+type_val +" </div>";
